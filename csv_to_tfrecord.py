...
def main():
    for directory in ['train','eval']:
        ...
        csv_path = os.path.join(os.getcwd(), '{}_labels.csv'.format(directory))
        output_path = os.path.join(os.getcwd(), '{}.record'.format(directory))
        label_map_dict = label_map_util.get_label_map_dict(os.path.join(os.getcwd(), 'label_map.pbtxt'))
        ...
        writer.close()
        print(directory + ' -Successfully created the TFRecords')
